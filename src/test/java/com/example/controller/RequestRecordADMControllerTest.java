...
class RequestRecordADMControllerTest {

        @InjectMocks
        private RequestRecordADMController controller;
	    ...
	    @Test
	    public void getRequestRecordADM() {
	        // Setup
	        ...
	        // Execute
	        String viewName = controller.getRequestRecordADM(model);
	        ...
	        assertEquals("admin/requestRecordADM", viewName);
	    }

	    @Test
	    public void getRequestRecordPaidDetailADM() {
	        // Setup
	        ...
	        // Execute
	        String viewName = controller.getRequestRecordPaidDetailADM(form, model, paidAppId);
	        ...
	        assertEquals("admin/requestRecordPaidDetailADM", viewName);
	    }
	    
	    @Test
	    public void getRequestRecordCorrectDetailADM() {
	        // Setup
	        ...
	        // Execute
	        String viewName = controller.getRequestRecordCorrectDetailADM(new CorrectRequestForm(), model, correctRequestId);
	        ...
	        assertEquals("admin/requestRecordCorrectDetailADM", viewName);
	    }
}
